...
const GstPackage = () => {
  ...
  const tableHeadings = ['SN', 'Package ID', 'Total Price', 'Business Text', 'Plan Duration', 'Status', 'Actions'];
  ...
  const ActionBtnsElement = ({ data }) => {
    return (
      <div className="flex gap-3">
        <ActionBtn tooltip='Edit Package' onClick={() => navigation(`/verificationteam/gst-package/edit/${data?.id}`)}>
    ...
    <div>
      <div className="flex justify-between items-center">
        ...
        <div className="flex items-center gap-3">
          ...
          {/* <CustomBtn onClick={() => navigation('/customer/gst-package/add')} >
            Add Package
          </CustomBtn> */}
        </div>
      </div>
